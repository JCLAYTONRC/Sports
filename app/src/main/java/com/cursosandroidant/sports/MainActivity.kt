...
class MainActivity : AppCompatActivity(), OnClickListener {
    ...
    private fun sports(): MutableList<Sport>{
        ...
        val tennisSport     = Sport(5, "Tennis",       "https://upload.wikimedia.org/wikipedia/commons/3/3e/Tennis_Racket_and_Balls.jpg")
    ...
    private suspend fun getWeather(): WeatherEntity = withContext(Dispatchers.IO){
        ...
        service.getWeatherById(3604614L, "metric", "1a7ebc2edbeedb9d00d3be8ed7e9c17c")
    }
           ...
           fibScope = CoroutineScope(Job() + exceptionHandler).launch(Dispatchers.Default) {
               if(it.toString().isNotEmpty()){
                   ...
                   withContext(Dispatchers.Main){
                       binding.tvResult.text = "R= ${"%d".format(fib)}\n(in ${System.currentTimeMillis() - time})ms"
                   }
               }
           }
        }
